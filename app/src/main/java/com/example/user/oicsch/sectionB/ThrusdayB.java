...
public class ThrusdayB extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        {
            case "Bsc CsitZero":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSCCSIT1BTHR.csv");
                Log.d("log",""+SDCardRoot);
                break;
            case "Bsc CsitOne":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSCCSIT2BTHR.csv");
                break;
            case "Bsc CsitTwo":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSCCSIT3BTHR.csv");
                break;
            case "Bsc CsitThree":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSCCSIT4BTHR.csv");
                break;
            case "BimZero":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BIM1BTHR.csv");
                break;
            case "BimOne":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BIM2BTHR.csv");
                break;
            case "BimTwo":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BIM3BTHR.csv");
                break;
            case "BimThree":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BIM4BTHR.csv");
                break;
            case "BswZero":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSW1BTHR.csv");
                break;
            case "BswOne":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSW2BTHR.csv");
                break;
            case "BswTwo":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSW3BTHR.csv");
                break;
            case "BswThree":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSW4BTHR.csv");
        }
        try {
