...
public class MondayB extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        {
            case "Bsc CsitZero":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSCCSIT1BMON.csv");
                Log.d("log",""+SDCardRoot);
                break;
            case "Bsc CsitOne":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSCCSIT2BMON.csv");
                break;
            case "Bsc CsitTwo":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSCCSIT3BMON.csv");
                break;
            case "Bsc CsitThree":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSCCSIT4BMON.csv");
                break;
            case "BimZero":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BIM1BMON.csv");
                break;
            case "BimOne":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BIM2BMON.csv");
                break;
            case "BimTwo":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BIM3BMON.csv");
                break;
            case "BimThree":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BIM4BMON.csv");
                break;
            case "BswZero":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSW1BMON.csv");
                break;
            case "BswOne":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSW2BMON.csv");
                break;
            case "BswTwo":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSW3BMON.csv");
                break;
            case "BswThree":
                SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/BSW4BMON.csv");
        }
        try {
