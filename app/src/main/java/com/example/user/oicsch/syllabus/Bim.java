    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        SyllabusRVAdapter adapter = new SyllabusRVAdapter(getContext(), sem, new SyllabusRVAdapter.OnCardClickListner() {
            ...
            public void OnCardClicked(View view, int position, String tag) {
                switch (position) {
                    case 0:
                        SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/Syllabus/Bim(First).pdf");
                        if(!SDCardRoot.exists())
                            SDCardRoot=null;
                        break;
                    case 1:
                        SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/Syllabus/Bim(Second).pdf");
                        if(!SDCardRoot.exists())
                            SDCardRoot=null;
                        break;
                    case 2:
                        SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/Syllabus/Bim(Third).pdf");
                        if(!SDCardRoot.exists())
                            SDCardRoot=null;
                        break;
                    case 3:
                        SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/Syllabus/Bim(Fourth).pdf");
                        if(!SDCardRoot.exists())
                            SDCardRoot=null;
                        break;
                    case 4:
                        SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/Syllabus/Bim(Fifth).pdf");
                        if(!SDCardRoot.exists())
                            SDCardRoot=null;
                        break;
                    case 5:
                        SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/Syllabus/Bim(Sixth).pdf");
                        if(!SDCardRoot.exists())
                            SDCardRoot=null;
                        break;
                    case 6:
                        SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/Syllabus/Bim(Seventh).pdf");
                        if(!SDCardRoot.exists())
                            SDCardRoot=null;
                        break;
                    case 7:
                        SDCardRoot = new File("/sdcard/Android/data/com.example.user.oicsch/Files/Syllabus/Bim(Eight).pdf");
                        if(!SDCardRoot.exists())
                            SDCardRoot=null;
                        break;
                    default:
